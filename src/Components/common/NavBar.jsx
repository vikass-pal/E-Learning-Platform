...
const NavBar = ({ setProgress }) => {
    ...
    return (
        <div className={` flex sm:relative bg-richblack-900 w-screen relative z-50 h-14 items-center justify-center border-b-[1px] border-b-richblack-700 translate-x-[-20px] transition-all duration-500`}>
            <div className='flex w-11/12 max-w-maxContent items-center justify-between'>
                ...
                {/* Desktop Navbar */}
                <nav>
                    <ul className=' flex-row gap-x-6 text-richblack-25 gap-5 hidden md:flex translate-x-[-40px]'>
                        {
